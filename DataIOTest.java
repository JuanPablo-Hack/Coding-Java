...
public class DataIOTest {
    public static void main(String[] args) throws IOException {
        ...
        //Conveniente con datos num�ricos (stream = secuencia de bytes)
        ...
        //           en el fichero "escribir.txt"
        DataOutputStream out = new DataOutputStream(new FileOutputStream("escribir.txt"));

        //EJERCICIO: Instancie un objeto de tipo DataInputStream para leer
        //           del fichero "leer.txt"
        DataInputStream in = new DataInputStream(new FileInputStream("leer.txt"));
